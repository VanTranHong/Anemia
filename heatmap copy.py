...
df = pd.read_csv('/Users/vantran/Desktop/PLOTS/f1_noboostbag.csv')
result = df.pivot(index = 'Feature Selection',columns = 'Classifier', values = 'F1')
...
res = sns.clustermap(result, method='average',linewidths=0.30,figsize=(10,7),annot = True,annot_kws={"size": 16},cbar_pos=None,cmap="vlag")
...
plt.savefig('heatmap_F1noboostbag.png')
plt.show()
